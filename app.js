...
client.on("chat", function(channel, user, message, self) {
    ...
    if(prefixUsed) {
        client.action("luke_lafr", "?luke ?teak ?nitro ?game ?subscribe ?amo ?crayon ?wyre ?donate ?extralife ?emma ?barrington ?job ?about ?moose ?mape ?jake ?csgo ?caltane ?overwatch");
    }
});
